...
public class Cinema{
    ...
    public Cinema(int rows, int seats) {
        this.seats = new String[rows][seats];// Først initialiseres arrayet.

        // Gå gennem alle pladser og sæt dem til "O" (ledig)
        for(int i = 0; i < rows; i++){          // Alle pladser er ledige ("O") til at starte med.
            for(int j = 0; j < seats; j++){     // Sæde [0][0] reserveres til direktøren.
            this.seats[i][j] ="0";
            }
        }
        this.seats[0][0] = "X";
